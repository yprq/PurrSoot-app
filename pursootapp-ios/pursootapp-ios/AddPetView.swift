...
struct AddPetView: View {
    ...
    @ObservedObject var viewModel: PetManager // Senin mimarinde PetManager veya AdoptViewModel
            ...
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 25) {
                        ...
                        customTextField(title: "Pet Name", text: $name, placeholder: "e.g. Husky")
                        ...
                        HStack(spacing: 15) {
                            // Backend INTEGER beklediği için sayısal değerler gönderiyoruz
                            customPicker(title: "Age", selection: $age, options: ["0", "1", "2", "3", "4", "5+"])
                            customPicker(title: "Size", selection: $size, options: ["Small", "Medium", "Large"])
                        }
    ...
    // ... imagePlaceholder, customTextField ve customPicker fonksiyonları aynı kalabilir ...
